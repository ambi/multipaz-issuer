        ...
        <div class="col-md-6 text-center">
            <div class="card border-success border-0 shadow-sm">
                <div class="card-body p-4">
                    <div class="fs-1 mb-3">🔍</div>
                    <h5 class="card-title">Photo ID を検証する</h5>
                    <p class="card-text text-muted mb-3">発行した Photo ID を OID4VP / Digital Credentials API で検証します。</p>
                    <a href="/verifier" class="btn btn-success px-4">Verifier を開く</a>
                </div>
            </div>
        </div>
    </div>
