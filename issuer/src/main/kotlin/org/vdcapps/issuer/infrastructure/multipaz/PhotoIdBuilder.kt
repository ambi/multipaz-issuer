...
class PhotoIdBuilder(
     ...
     */
    fun ecPublicKeyFromCoordinates(
        xBytes: ByteArray,
        yBytes: ByteArray,
    ): EcPublicKey = EcPublicKeyDoubleCoordinate(EcCurve.P256, normalize32(xBytes), normalize32(yBytes))
    ...
    private fun normalize32(bytes: ByteArray): ByteArray =
        when {
